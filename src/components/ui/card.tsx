...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-2xl bg-card/95 py-(--card-spacing) text-sm text-card-foreground !shadow-[0_1px_2px_oklch(0_0_0/0.04),0_10px_32px_oklch(0_0_0/0.055)] ring-1 ring-foreground/8 transition-[box-shadow,transform,ring-color] duration-200 [--card-spacing:--spacing(4)] hover:!shadow-[0_2px_4px_oklch(0_0_0/0.045),0_16px_40px_oklch(0_0_0/0.075)] has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(3)] data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-t-2xl *:[img:last-child]:rounded-b-2xl",
        className
      )}
      {...props}
    />
